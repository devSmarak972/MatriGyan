...
function ResourceCard(props) {
  return (
    <div className="shadow-[0_0px_20px_0_rgb(0,0,0,0.05)] rounded-2xl hover:scale-105 ease-in-out duration-300">
      <div className="flex flex-col">
        <img
          ...
          alt="image"
        />
        <div className="bg-white rounded-b-xl duration-300 -mt-8 grow p-4">
          <div>
            <a
              href="#"
