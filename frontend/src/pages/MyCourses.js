    ...
    <div class="main-content w-full px-[var(--margin-x)] pb-8">
          ...
          <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            <div class="card justify-between bg-primary p-4 dark:bg-accent sm:p-5">
              <div class="flex items-center space-x-3 text-white">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/others/product-box.jpg" alt="image"/>
                <div>
            ...
            <div class="card justify-between p-4 sm:p-5">
              <div class="flex items-center space-x-3">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/others/design-sm.jpg" alt="image"/>
                <div>
            ...
            <div class="card justify-between p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/others/check-report-sm.jpg" alt="image"/>
                <div>
                  <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                    Weekly meeting
                  </h3>
        ...
        <div class="mt-4 sm:mt-5 lg:mt-6">
          ...
          <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            <div class="card justify-between p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/others/sales-presentation-sm.jpg" alt="image"/>
                <div>
                  <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                    Sales Presentation
                  </h3>
              ...
              <div class="mt-4">
                ...
                <div class="mt-5 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-8 w-8 hover:z-10">
                      <img class="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-6.jpg" alt="avatar"/>
                    </div>
                  </div>
                  <button class="btn h-8 w-8 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card justify-between p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/others/testing-sm.jpg" alt="image"/>
                <div>
                  <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                    Testing Vol.1
                  </h3>
              ...
              <div class="mt-4">
                ...
                <div class="mt-5 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    <div class="avatar h-8 w-8 hover:z-10">
                      <img class="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-7.jpg" alt="avatar"/>
                    </div>
                    <div class="avatar h-8 w-8 hover:z-10">
        ...
        <div class="mt-4 sm:mt-5 lg:mt-6">
          ...
          <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
            <div class="card justify-between p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/illustrations/dashboard-meet-dark.svg" alt="image" />
                <div>
                  <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                    New App Analysis
                  </h3>
              ...
              <div class="mt-4">
                ...
                <div class="mt-5 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-8 w-8 hover:z-10">
                      <img class="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-9.jpg" alt="avatar" />
                    </div>
                  </div>
                  <button class="btn h-8 w-8 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card justify-between p-4 sm:p-5">
              <div class="flex items-center space-x-4">
                <img class="h-10 w-10 shrink-0 rounded-lg object-cover" src="images/logos/react.svg" alt="image" />
                <div>
                  <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                    React Conf
                  </h3>
              ...
              <div class="mt-4">
                ...
                <div class="mt-5 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-8 w-8 hover:z-10">
                      <img class="rounded-full ring ring-white dark:ring-navy-700" src="images/avatar/avatar-13.jpg" alt="avatar" />
                    </div>
                  </div>
                  <button class="btn h-8 w-8 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor">
