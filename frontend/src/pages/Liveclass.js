...
const Liveclass = () => {
  ...
  return (
    <div class="container-room liveclass">
      <div class="left-cont">
      ...
      <div class="right-cont">
        <div class="head-title">
          <div
            class={activeTab==="chatTab"?"chats border-b-4 border-indigo-500":"chats hover:border-b-4 border-gray"}
            onClick={(e) => setActiveTab("chatTab")}
          >
            <i class="fas fa-comment-alt mr-1"></i>Chats
          </div>
          <div
            class={activeTab==="attendeeTab"?"attendies border-b-4 border-indigo-500":"attendies hover:border-b-4 border-gray"}
